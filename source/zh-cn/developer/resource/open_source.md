...
- 版本号: 04020021   /  更新时间: 2016.12.28 18:37   /   [资源下载:戳我>>](http://gizwits.oss.aliyuncs.com/hardware_resource/GAgent_00ESP826_04020021_16122717.tar) 
   - 更新信息
      - 修改版本号为04020021 
      - 支持使用安全注册接口,需MCU配套支持;
      - 提供时区设置的精度,支持设置0.25等时区;
      - OTA下载支持断点续传,提高ota成功率; 
      - did在云端不存在时，重新注册did; 
      - 新增上报MCU设备属性 
      - 其它优化
   ...
   1. 版本号: 04020019     /  更新时间: 2016.10.19 14:13      /  [资源下载:戳我>>](http://gizwits.oss.aliyuncs.com/hardware_resource/GAgent_00ESP826_04020019_16101715_combine.zip)
    - 更新信息
         1. 版本号更新为04020019 
         2. 增加flash断电保护机制 
         3. 域名信息同步给APP 
...
- **旧版本下载**
   ...
   1. 版本号: 04020016  / 更新时间: 2016.10.18 11:37  /   [资源下载:戳我>>](http://gizwits.oss.aliyuncs.com/hardware_resource/GAgent_LPB100_04020016_16100917.tar)
     - 更新信息
       1. 版本更新为04020016 
