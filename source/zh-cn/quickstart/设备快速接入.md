...
---
# mcu快速开发LED灯参考代码
附件：[mcu快速开发LED灯参考代码](/assets/pdf/mcu快速开发LED灯参考代码.zip)
...
![](/assets/zh-cn/quickstart/dev/image2.png)

## 2.登录账号，选择对应项创建新产品

![创建新产品图](/assets/zh-cn/quickstart/dev/image3.png)

## 3.填写设备产品基本信息

![填写设备产品基本信息图](/assets/zh-cn/quickstart/dev/image4.png)
...
![项目基本信息图](/assets/zh-cn/quickstart/dev/image5.png)
...
![创建数据点-2](/assets/zh-cn/quickstart/dev/image10.png)

## 5.修改数据点

![修改数据点-1](/assets/zh-cn/quickstart/dev//image11.png)

![修改数据点-2](/assets/zh-cn/quickstart/dev/image12.png)

![修改数据点-3](/assets/zh-cn/quickstart/dev/image13.png)

![修改数据点-4](/assets/zh-cn/quickstart/dev/image14.png)
...
![自动生成MCU SDK-1](/assets/zh-cn/quickstart/dev/image15.png)

![自动生成MCU SDK-1](/assets/zh-cn/quickstart/dev/image16.png)

![外接GoKit扩展口A2](/assets/zh-cn/quickstart/dev/image17.png)
...
![注册登录APP账号](/assets/zh-cn/quickstart/dev/image30.png)

## 3. 配置WiFi模块入网

![配置WiFi模块入网-1](/assets/zh-cn/quickstart/dev/image31.png)

![配置WiFi模块入网-2](/assets/zh-cn/quickstart/dev/image32.png)

![配置WiFi模块入网-3](/assets/zh-cn/quickstart/dev/image33.png)

## 4. 配置成功后，选择相应设备

![选择相应设备](/assets/zh-cn/quickstart/dev/image34.png)

## 5. APP收发设备数据

![APP收发设备数据](/assets/zh-cn/quickstart/dev/image35.png)
...
![马上申请](/assets/zh-cn/quickstart/dev/image38.png)
