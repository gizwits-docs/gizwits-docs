...
准备好串口工具之后，解压章节2下载的压缩包，解压烧录工具文件夹中的压缩包，双击ESPFlashDownloadTool_v3.6.1.0.exe文件，选择ESP32 DownloadTool，按照下图的选项，填写对应的地址，选择对应的SPI Flash选项，选择好串口与波特率，点击START。
...
>  **若固件名称带有combine字眼，则从0地址烧写，详细看下图。**
