...
机智云自研的串口通信协议GAgent赋予汉枫HF-LPB100/HF-LPT120联网能力。只需在模组上烧写Gagent固件，即可实现上层应用（手机APP等控制端、云端）到产品设备的双向数据通讯，此外，还提供对设备的配置入网、发现绑定、程序升级等功能。
...
![输入图片说明](https://static.oschina.net/uploads/img/201704/07182938_aqr2.png "在这里输入图片标题")
